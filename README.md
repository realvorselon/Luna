...
- `docs/GUIDED_RETURN_MOTION_EXPERIMENT_BOUNDARY.md` — a concise boundary note for deciding whether one tiny guided-stage motion cue should be tested next without extending the full sequence by default.
