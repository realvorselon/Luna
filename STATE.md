...
Rest after making Shape this return suggestions reversible one field at a time.
...
Human-test selective Apply → Undo behavior on mobile, including applying multiple different suggestions, undoing one without affecting the others, refreshing after an applied value, and reopening Shape this return to confirm guidance is recomputed from current saved context.
