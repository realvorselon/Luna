...
- 2026-07-09: Cleaned up stale wording so the public trail consistently says the current guidance reads from Welcome through Record the Change, with Next Action, Ignore For Now, and Record the Change as the top return path before resting.
